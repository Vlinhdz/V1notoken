...
local Tabs = {
    Main = Window:AddTab({ Title = "Tap Main" }),
    Stats = Window:AddTab({ Title = "Tap Sub" }),
    Info = Window:AddTab({ Title = "Tap Status" }),
    Seaev = Window:AddTab({ Title = "Tap Sea Event" }),
    Player = Window:AddTab({ Title = "Tap Player" }),
    Teleport = Window:AddTab({ Title = "Tap Teleport" }),
    Fruit = Window:AddTab({ Title = "Tap Blox Fruits" }),
    Raid = Window:AddTab({ Title = "Tap Raids" }),
    Race = Window:AddTab({ Title = "Tap Update Race" }),
    Shop = Window:AddTab({ Title = "Tap Shop" }),
    Misc = Window:AddTab({ Title = "Tap Misc" }),
    Hop = Window:AddTab({ Title = "Tap Server" }),
    Setting = Window:AddTab({ Title = "Tap Settings" }),
    Fluent = Window:AddTab({ Title = "Tap Config" }),
}
...
-- print (info)
    ...
    print("made by phamvanlinh. ")
    print("Rikka x Hub")
    print("my discord https://discord.com/invite/NVzgsVfNbu")
    print("sever : https://discord.com/invite/NVzgsVfNbu")
    print("ty for using - have fun")
    print("sk (on discord : @phamvanlinh.)")
    print("wait ,.,")
    print("LCTSV - .,.")  
--[[notify
...
task.delay(1 * 10,function() 
    ...
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow> join my discord server : https://discord.com/invite/NVzgsVfNbu<Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Purple> ty for using elite gamer Hub - have fun:P <Color=/>"):Display()
